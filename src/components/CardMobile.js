    ...
    <div className="card-mobile-wrapper">
      <div className="card-mobile-upper-section">
        ...
        <div className="card-mobile-headers">
          <h1 className="card-mobile-header">{props.header}</h1>
          <h2 className="card-mobile-year">{props.year}</h2>
          <div className="card-mobile-badges">{badgeItems}</div>
        </div>
      </div>
      <div className="card-mobile-lower-section">
        <p className="card-mobile-description">{props.body}</p>
        <div className="card-mobile-buttons">
          {props.projectURL && (
            <Button
              className="card-mobile-button"
