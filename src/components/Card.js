            ...
            <div className='card-body-wrapper'>
                ...
                <div className='card-lower-section'>
                    ...
                    <div className='card-buttons'>
                        <Button className='card-button' src={view_project_icon} size='small' url={props.projectURL}>View Project</Button>
                        <Button className='card-button' src={github_icon} size='small' url={props.codeURL}>View Code</Button>
                    </div>
                </div>
            </div>
