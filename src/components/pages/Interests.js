...
function Interests() {
  ...
  const getSelectedRecordData = useCallback(() => {
    ...
    if (selectedRecord === "metallica") {
      ...
      description =
        "Metallica performed at the Singapore Indoor Stadium as part of their WorldWired Tour in 2017. As a huge Metallica fan, this was undoubtedly the most memorable concert I have ever attended.";
      name = "Metallica";
      ...
      description =
        "Red Hot Chili Peppers performed at The Padang as part of the Formula 1 Singapore Grand Prix in 2019. Their energertic set consisting of hits from various albums definitely left me wanting for more.";
      ...
      description =
        "Queen and Adam Lambert performed at The Padang as part of the Formula 1 Singapore Grand Prix in 2016. I was thrilled to see original band members like Brian May perform all the crowd favourites!";
      ...
      description =
        "Muse performed at The Padang as part of the Formula 1 Singapore Grand Prix in 2019. They put on an electrifying performance consisting of songs from their latest album as well as their older hits.";
      name = "Muse";
      ...
      description =
        "Mike Shinoda performed at Zepp @ BigBox Singapore as part of his Post Traumatic Tour in 2018. After Chester Bennington's untimely death, I was glad to be able to watch Mike Shinoda perform some Linkin Park crowd favourites as well as his solo projects!";
      name = "Mike Shinoda";
    } else {
      record_image = null;
      concert_image = null;
    ...
    <div className="interests-wrapper" id="interests">
      ...
      <div className="music-wrapper">
        ...
        <div className="turntable-container">
          <div className="turntable-wrapper">
            {selectedRecord ? (
              <img
                className={`selected-record-image ${
                  recordAnimate ? "animate-record" : ""
                }`}
                src={getSelectedRecordData().record_image}
                alt={`${getSelectedRecordData().name} record`}
              />
            ) : (
              <div className="turntable-instructions">
                click on any of the records to view more details!
              </div>
            )}
            <img
              className={
                needleAnimate ? "needle-image animate-needle" : "needle-image"
              }
              onAnimationEnd={() => {
                setRecordAnimate(true);
              }}
              src={needle_image}
              alt="needle"
            />
          ...
          <div className="record-catalog">
            <img
              className={`record-img ${
                selectedRecord === "queen" ? "selected-record" : ""
              }`}
              onClick={(e) => {
                onRecordClick(e, "queen");
              }}
              src={queen_record}
              alt="Queen record"
            />
            <img
              className={`record-img ${
                selectedRecord === "metallica" ? "selected-record" : ""
              }`}
              onClick={(e) => {
                onRecordClick(e, "metallica");
              }}
              src={metallica_record}
              alt="Metallica record"
            />
            <img
              className={`record-img ${
                selectedRecord === "gnr" ? "selected-record" : ""
              }`}
              onClick={(e) => {
                onRecordClick(e, "gnr");
              }}
              src={gnr_record}
              alt="Guns N Roses Record"
            />
            <img
              className={`record-img ${
                selectedRecord === "shinoda" ? "selected-record" : ""
              }`}
              onClick={(e) => {
                onRecordClick(e, "shinoda");
              }}
              src={shinoda_record}
              alt="Mike Shinoda Record"
            />
            <img
              className={`record-img ${
                selectedRecord === "muse" ? "selected-record" : ""
              }`}
              onClick={(e) => {
                onRecordClick(e, "muse");
              }}
              src={muse_record}
              alt="Muse record"
            />
            <img
              className={`record-img ${
                selectedRecord === "rhcp" ? "selected-record" : ""
              }`}
              onClick={(e) => {
                onRecordClick(e, "rhcp");
              }}
              src={rhcp_record}
              alt="Red Hot Chili Peppers Record"
            />
        ...
        <div
          ...
          style={{ display: recordAnimate ? "flex" : "none" }}
        >
          <img
            className="concert-img"
            src={getSelectedRecordData().concert_image}
            alt={`${getSelectedRecordData().name} concert`}
          />
          <div className="concert-title">{getSelectedRecordData().title}</div>
          <div className="concert-description">
            {getSelectedRecordData().description}
          </div>
        </div>
      </div>
      <div className="dogs-wrapper">
        ...
        <div className="dog-images-container">
          <Gallery
            photos={photos}
            className="dog-images-container"
